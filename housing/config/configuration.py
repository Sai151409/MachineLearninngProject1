...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            transformed_dir = os.path.join(data_transformation_artifact_dir, data_transformation_info[DATA_TRANSFORMATION_DIR_NAME_KEY])
            
            transformed_train_dir = os.path.join(transformed_dir, data_transformation_info[DATA_TRANSFORMATION_TRAIN_DIR_NAME_KEY])
    ...
    def get_training_pipeline_config(self) -> TrainingPipelineConfig:
        try:
            ...
            artifac_dir = os.path.join(ROOT_DIR,
                                        training_pipeline_config[TRAINING_PIPELINE_NAME_KEY],
                                        training_pipeline_config[TRAINING_PIPELINE_ARTIFACT_DIR_KEY])
            training_pipeline_config = TrainingPipelineConfig(artifact_dir=artifac_dir)
